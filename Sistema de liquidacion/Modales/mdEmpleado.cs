...
{
    public partial class mdEmpleado : Form
    {
        ...
        {
            Visualizer(empleadoService.FiltroEstado());
        }
        ...
        private void Visualizer(List<Empleado> lista)
        {
            ...
            if (lista != null)
            {
                foreach (var producto in lista)
                {
                    ...
                    row.Cells["IdProducto"].Value = producto.IdPersona;
        ...
        private void tblRegistro_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (tblRegistro.Columns[e.ColumnIndex].Name == "btnSeleccionar")
            {
                ...
                if (index >= 0)
                {
                    ...
                    {
                        IdPersona = Convert.ToInt32(tblRegistro.Rows[index].Cells["IdProducto"].Value.ToString()),
